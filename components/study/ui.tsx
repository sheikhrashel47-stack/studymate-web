...
export const styles = StyleSheet.create({
  ...
  card: { backgroundColor: colors.glass, borderColor: colors.emeraldBorder, borderWidth: 1, borderRadius: 18, padding: 15, shadowColor: colors.blueDark, shadowOffset: { width: 0, height: 5 }, shadowOpacity: 0.06, shadowRadius: 14, elevation: 2 },
  ...
  buttonSecondary: { backgroundColor: colors.softBlue, borderColor: colors.emeraldBorder, borderWidth: 1 },
